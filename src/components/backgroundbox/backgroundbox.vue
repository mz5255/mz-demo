<template>
    <svg class="svg-content" :width="w" :height="h">
        ...
        <polyline class="corner-rect0" :stroke="stroke" :fill="fill" :points="svgobj.cornerrect0">
        </polyline>
        <polyline class="corner-rect1" :stroke="stroke" :fill="fill" :points="svgobj.cornerrect1">
        </polyline>
        <polyline class="corner-rect2" :stroke="stroke" :fill="fill" :points="svgobj.cornerrect2">
        </polyline>
        <polyline class="corner-rect3" :stroke="stroke" :fill="fill" :points="svgobj.cornerrect3">
        </polyline>
        <polyline class="corner-rect4" :stroke="stroke" :fill="fill" :points="svgobj.cornerrect4">
        </polyline>
        ...
        <polyline class="corner-LBTriangle" :stroke="stroke" :fill="fill" :points="svgobj.cornerLBTriangle">
        </polyline>
        <polyline class="corner-LBLine" :stroke="stroke" :fill="fill" :points="svgobj.cornerLBLine"></polyline>
    </svg>
</template>
<script>
export default {
    data() {
        return {
            svgobj: {
                svgbg: "145, 297 35, 297 3, 265 3, 25 25, 3 207, 3 228, 25 363, 25 375 , 40 375 , 275 375 , 275 353 , 297 145, 297",
                // cornerLBLongDec: "3, 200 3, 265 35, 297 100, 297 90, 293 37, 293 7, 263 7, 204 3, 200",
                cornerrect0: "214, 12 262, 12 273, 24 225, 24",
                cornerrect1: "272, 12 282, 12 293, 24 283, 24",
                cornerrect2: "292, 12 302, 12 313, 24 303, 24",
                cornerrect3: "312, 12 322, 12 333, 24 323, 24",
                cornerrect4: "332, 12 342, 12 353, 24 343, 24",
                cornerLTTriangle: "8, 8 16, 8 8,16 8, 8",
                cornerRBTriangle: "375, 297 375, 284 362, 297 375, 297",
                cornerLBTriangle: "8, 292 8, 285 15, 292 8, 292",
                cornerLBLine: "6, 278 22, 294 30, 294 6, 270",
            },
            oldw: 378,
            oldh: 300
        }
